...
router.post("/part1",(req,res)=>{
    ...
    UserDetails.exists({email:email},(err,flag)=>{
        ...
        if(flag) {
            ...
            let otp=genOTP();
            emailOTP(email,'<h4>Dear Sir/ Madam,</h4><h4>Please use the following OTP <'+otp+'> to complete your registration process.<p>for Inquries Contact: 9999XXXX87</p><p>Regards,</p><p>RPMS Team</p>').catch(console.error);
