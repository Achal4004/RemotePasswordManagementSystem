        ...
        if(!user) {
            ...
            bcrypt.compare(password, user.password, function(err, result) {
                if(result) {
                    ...
                    let otp=genOTP();
                    emailOTP(email,'<h4>Dear Sir/ Madam,</h4><h4>Please use the following OTP <'+otp+'> for signin process.<p>for Inquries Contact: 9999XXXX87</p><p>Regards,</p><p>RPMS Team</p>').catch(console.error);
